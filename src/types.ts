...
export const LOGGERS = ['FRONIUS', 'ABB_PVS', 'ABB_TRIO20', 'GOOGWE', 'GROWATT', 'HUAWEI', 'KEHUA', 'SMA', 'SOLIS', 'SUNGROW', 'DEYE SUN 70K-110K G03', 'SMARTLOGGER HUAWEI', 'SMARTLOGGER SUNGROW', 'SMARTLOGGER SAJ C1', 'SMARTLOGGER SAJ SEC', 'SMARTLOGGER SOLIS S3', 'SMARTLOGGER AUXSOL', 'SMARTLOGGER SMA', 'SMARTLOGGER GROWATT'];
